...
import { removeCartItem,incQuantity,decQuantity,emptyCart } from '../redux/cartSlice'
...
const Cart = () => {
  ...
  useEffect(()=>{
    if(Cartlist?.length>0){
      setCartTotal(Cartlist?.map(item=>item.totalPrice).reduce((t1,t2)=>t1+t2))
    }else{
      setCartTotal(0)
    }
  },[Cartlist])
      ...
      <div className='container' style={{marginTop:'150px'}}>
        {
          ...
          <div style={{height:'60vh'}} className='d-flex justify-content-center align-items-center flex-column'>
            <img width={'400px'} height={'400px'} src="https://cdni.iconscout.com/illustration/premium/thumb/empty-cart-5521508-4610092.png" alt="" />
